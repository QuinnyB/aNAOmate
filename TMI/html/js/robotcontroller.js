function RobotController() {
    ...
    RobotUtils.onServices(async function (ALMemory, ALTextToSpeech, ALBehaviorManager, ALRobotPosture, ALAutonomousLife, ALMotion, ALAudioDevice, ALAnimatedSpeech) {
        ...
        await ALBehaviorManager.getLoadedBehaviors()
    ...
    this.getStatus = async function () {
        ...
        await ALBehaviorManager.getRunningBehaviors()
            .then(behaviorList => {
